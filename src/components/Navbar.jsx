      ...
      {open && (
        <div className="md:hidden border-t border-white/10 bg-zinc-900/80 backdrop-blur">
          <div className="px-4 py-3 flex flex-col">
            <a onClick={() => setOpen(false)} href="/#work" className="py-2 text-zinc-300 hover:text-white">Werk</a>
            <a onClick={() => setOpen(false)} href="/#studio" className="py-2 text-zinc-300 hover:text-white">Studio</a>
            <a onClick={() => setOpen(false)} href="/#services" className="py-2 text-zinc-300 hover:text-white">Diensten</a>
